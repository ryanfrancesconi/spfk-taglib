 ...
 * See <a
 * href="https://github.com/taglib/taglib/blob/master/tests/test_id3v2framefactory.cpp">
...
public:
   ...
   */
  virtual Frame *createFrame(const ByteVector &origData,
   ...
   */
  virtual Frame *createFrameForProperty(const String &key,
...
protected:
  ...
  prepareFrameHeader(ByteVector &data, const Header *tagHeader) const;
