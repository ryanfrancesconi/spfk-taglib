...
public:
   ...
   */
  static TextIdentificationFrame *
  createTIPLFrame(const PropertyMap &properties);
   ...
   */
  static TextIdentificationFrame *
  createTMCLFrame(const PropertyMap &properties);
  /*!
  ...
  /*!
   * Returns a KeyConversionMap mapping a role as it would be  used in a
   * PropertyMap to the corresponding key used in a TIPL ID3 frame to describe
   * that role.
   */
...
class TAGLIB_EXPORT UserTextIdentificationFrame
...
public:
  ...
  /*!
   * Creates a user defined text identification frame with the given \a
   * description and \a values.
   */
  UserTextIdentificationFrame(const String &description,
  ...
  operator=(const UserTextIdentificationFrame &) = delete;
  ...
  /*!
   * Searches for the user defined text frame with the description \a
   * description in \a tag.  This returns null if no matching frames were found.
   */
  static UserTextIdentificationFrame *find(const Tag *tag,
                                           const String &description);

  /*!
   * Returns an appropriate TXXX frame description for the given free-form tag
   * key.
   */
